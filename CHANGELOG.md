...
* `resource/vsphere_virtual_machine`: The `moid` attribute has now be re-added
  ...
  ([#390](https://github.com/mproffitt/terraform-provider-vsphere/issues/390))
...
* `resource/vsphere_virtual_machine`: Fixed a crash scenario that can happen
  ...
  or under certain circumstances such an expired vCenter license. ([#414](https://github.com/mproffitt/terraform-provider-vsphere/issues/414))
* `resource/vsphere_virtual_machine`: Corrected an issue reading disk capacity
  values after a vCenter or ESXi upgrade. ([#405](https://github.com/mproffitt/terraform-provider-vsphere/issues/405))
* `resource/vsphere_virtual_machine`: Opaque networks, such as those coming from
  ...
  machines. ([#398](https://github.com/mproffitt/terraform-provider-vsphere/issues/398))

## 1.3.2 (February 07, 2018)

BUG FIXES:

* `resource/vsphere_virtual_machine`: Changed the update implemented in ([#377](https://github.com/mproffitt/terraform-provider-vsphere/issues/377))
  ...
  ([#391](https://github.com/mproffitt/terraform-provider-vsphere/issues/391))
...
* `resource/vsphere_virtual_machine`: Looking up templates by their UUID now
  functions correctly for vSphere 6.0 and earlier. ([#377](https://github.com/mproffitt/terraform-provider-vsphere/issues/377))
...
* `resource/vsphere_virtual_machine`: Fixed an issue where certain changes
  ...
  type) were resulting in invalid device change operations. ([#371](https://github.com/mproffitt/terraform-provider-vsphere/issues/371))
* `resource/vsphere_virtual_machine`: Introduced the `label` argument, which
  ...
  position on the SCSI bus. ([#363](https://github.com/mproffitt/terraform-provider-vsphere/issues/363))
* `resource/vsphere_virtual_machine`: Introduced the `path` argument, which
  ...
  pointing to the current path of any specific virtual disk. ([#363](https://github.com/mproffitt/terraform-provider-vsphere/issues/363))
* `resource/vsphere_virtual_machine`: Introduced the `uuid` attribute, a new
  ...
  freshly-created or added virtual disks. ([#363](https://github.com/mproffitt/terraform-provider-vsphere/issues/363))
* `resource/vsphere_virtual_machine`: The virtual disk `name` argument is now
  ...
  and `path` attributes. ([#363](https://github.com/mproffitt/terraform-provider-vsphere/issues/363))
* `resource/vsphere_virtual_machine`: Cloning no longer requires you to choose a
  disk label (name) that matches the name of the VM. ([#363](https://github.com/mproffitt/terraform-provider-vsphere/issues/363))
* `resource/vsphere_virtual_machine`: Storage vMotion can now be performed on
  renamed virtual machines. ([#363](https://github.com/mproffitt/terraform-provider-vsphere/issues/363))
* `resource/vsphere_virtual_machine`: Storage vMotion no longer cares what your
  ...
  criteria added after 1.1.1. ([#363](https://github.com/mproffitt/terraform-provider-vsphere/issues/363))
* `resource/vsphere_virtual_machine`: Storage vMotion now works on linked
  clones. ([#363](https://github.com/mproffitt/terraform-provider-vsphere/issues/363))
* `resource/vsphere_virtual_machine`: The import restrictions for virtual disks
  ...
  supported. ([#363](https://github.com/mproffitt/terraform-provider-vsphere/issues/363))
* `resource/vsphere_virtual_machine`: Now supports setting vApp properties that
  usually come from an OVF/OVA template or virtual appliance. ([#303](https://github.com/mproffitt/terraform-provider-vsphere/issues/303))

## 1.2.0 (January 11, 2018)

FEATURES:

* **New Resource:** `vsphere_custom_attribute` ([#229](https://github.com/mproffitt/terraform-provider-vsphere/issues/229))
* **New Data Source:** `vsphere_custom_attribute` ([#229](https://github.com/mproffitt/terraform-provider-vsphere/issues/229))
...
* All vSphere provider resources that are capable of doing so now support custom
  ...
  ([#229](https://github.com/mproffitt/terraform-provider-vsphere/issues/229))
* `resource/vsphere_virtual_machine`: The resource will now disallow a disk's
  ...
  computed value from a resource). ([#329](https://github.com/mproffitt/terraform-provider-vsphere/issues/329))
...
* `resource/vsphere_virtual_machine`: Fixed an issue that was causing crashes
  ...
  occupying the first available device slot on the PCI bus. ([#344](https://github.com/mproffitt/terraform-provider-vsphere/issues/344))
...
* `resource/vsphere_virtual_machine`: Network interface resource allocation
  ...
  on vSphere 5.5. ([#322](https://github.com/mproffitt/terraform-provider-vsphere/issues/322))
* `resource/vsphere_virtual_machine`: Resources that were deleted outside of
  ...
  re-created during the next apply. ([#321](https://github.com/mproffitt/terraform-provider-vsphere/issues/321))
* `resource/vsphere_virtual_machine`: Added some restrictions to storage vMotion
  ...
  states. ([#319](https://github.com/mproffitt/terraform-provider-vsphere/issues/319))
* `resource/vsphere_virtual_machine`: The resource now treats disks that it does
  ...
  `keep_on_remove` to safely remove them. ([#317](https://github.com/mproffitt/terraform-provider-vsphere/issues/317))
* `resource/vsphere_virtual_machine`: The resource now attempts to detect unsafe
  ...
  provider will block such operations from proceeding. ([#305](https://github.com/mproffitt/terraform-provider-vsphere/issues/305))
...
* `resource/vsphere_virtual_machine`: Fixed a bug with NIC device assignment
  logic that was causing a crash when adding more than 3 NICs to a VM. ([#280](https://github.com/mproffitt/terraform-provider-vsphere/issues/280))
* `resource/vsphere_virtual_machine`: CDROM devices on cloned virtual machines
  are now connected properly on power on. ([#278](https://github.com/mproffitt/terraform-provider-vsphere/issues/278))
* `resource/vsphere_virtual_machine`: Tightened the pre-clone checks for virtual
  ...
  and the created virtual machine's configuration. ([#277](https://github.com/mproffitt/terraform-provider-vsphere/issues/277))
...
* `resource/vsphere_virtual_machine`: Fixed an issue in the post-clone process
  when a CDROM device exists in configuration. ([#276](https://github.com/mproffitt/terraform-provider-vsphere/issues/276))
...
* `resource/vsphere_virtual_machine`: Fixed issues related to correct processing
  ...
  amount that will ultimately end up in configuration. ([#269](https://github.com/mproffitt/terraform-provider-vsphere/issues/269))
* `resource/vsphere_virtual_machine`: Version comparison logic now functions
  ...
  vSphere. ([#272](https://github.com/mproffitt/terraform-provider-vsphere/issues/272))
...
* `resource/vsphere_virtual_machine`: Corrected an issue that was preventing the
  use of this resource on standalone ESXi. ([#263](https://github.com/mproffitt/terraform-provider-vsphere/issues/263))
* `data/vsphere_resource_pool`: This data source now works as documented on
  standalone ESXi. ([#263](https://github.com/mproffitt/terraform-provider-vsphere/issues/263))
...
* **New Data Source:** `vsphere_resource_pool` ([#244](https://github.com/mproffitt/terraform-provider-vsphere/issues/244))
* **New Data Source:** `vsphere_datastore` ([#244](https://github.com/mproffitt/terraform-provider-vsphere/issues/244))
* **New Data Source:** `vsphere_virtual_machine` ([#244](https://github.com/mproffitt/terraform-provider-vsphere/issues/244))
...
* `resource/vsphere_virtual_machine`: The distinct VM workflows are now better
  ...
  ([#244](https://github.com/mproffitt/terraform-provider-vsphere/issues/244))
* `resource/vsphere_virtual_machine`: Nearly all customization options have now
  ...
  OS being customized. ([#244](https://github.com/mproffitt/terraform-provider-vsphere/issues/244))
* `resource/vsphere_virtual_machine`: Device management workflows have been
  greatly improved, exposing more options and fixing several bugs. ([#244](https://github.com/mproffitt/terraform-provider-vsphere/issues/244))
* `resource/vsphere_virtual_machine`: Added support for CPU and memory hot-plug.
  ...
  powered on, guest type and VMware tools permitting in some cases. ([#244](https://github.com/mproffitt/terraform-provider-vsphere/issues/244))
* `resource/vsphere_virtual_machine`: The resource now supports both host and
  ...
  datastore with a VM located in another. ([#244](https://github.com/mproffitt/terraform-provider-vsphere/issues/244))
* `resource/vsphere_virtual_machine`: The resource now supports import. ([#244](https://github.com/mproffitt/terraform-provider-vsphere/issues/244))
* `resource/vsphere_virtual_machine`: Several other minor improvements, see
  documentation for more details. ([#244](https://github.com/mproffitt/terraform-provider-vsphere/issues/244))

BUG FIXES:

* `resource/vsphere_virtual_machine`: Several long-standing issues have been fixed,
  namely surrounding virtual disk and network device management. ([#244](https://github.com/mproffitt/terraform-provider-vsphere/issues/244))
* `resource/vsphere_host_virtual_switch`: This resource now correctly supports a
  configuration with no NICs. ([#256](https://github.com/mproffitt/terraform-provider-vsphere/issues/256))
* `data/vsphere_network`: No longer restricted to being used on vCenter. ([#248](https://github.com/mproffitt/terraform-provider-vsphere/issues/248))

## 0.4.2 (October 13, 2017)

FEATURES:

* **New Data Source:** `vsphere_network` ([#201](https://github.com/mproffitt/terraform-provider-vsphere/issues/201))
* **New Data Source:** `vsphere_distributed_virtual_switch` ([#170](https://github.com/mproffitt/terraform-provider-vsphere/issues/170))
* **New Resource:** `vsphere_distributed_port_group` ([#189](https://github.com/mproffitt/terraform-provider-vsphere/issues/189))
* **New Resource:** `vsphere_distributed_virtual_switch` ([#188](https://github.com/mproffitt/terraform-provider-vsphere/issues/188))
...
* resource/vsphere_virtual_machine: The customization waiter is now tunable
  ...
  adjusted or the waiter can be disabled altogether. ([#199](https://github.com/mproffitt/terraform-provider-vsphere/issues/199))
* resource/vsphere_virtual_machine: `domain` now acts as a default for
  ...
  used as a last resort only. ([#185](https://github.com/mproffitt/terraform-provider-vsphere/issues/185))
* resource/vsphere_virtual_machine: Expose the `adapter_type` parameter to allow
  ...
  ([#193](https://github.com/mproffitt/terraform-provider-vsphere/issues/193))
...
* resource/vsphere_virtual_machine: Fixed a regression with network discovery
  ...
  ([#198](https://github.com/mproffitt/terraform-provider-vsphere/issues/198))
* All resources that can use tags will now properly remove their tags completely
  ...
  in configuration. ([#196](https://github.com/mproffitt/terraform-provider-vsphere/issues/196))
...
* resource/vsphere_folder: Migration of state from a version of this resource
  before v0.4.0 now works correctly. ([#187](https://github.com/mproffitt/terraform-provider-vsphere/issues/187))
...
* The `vsphere_folder` resource has been re-written, and its configuration is
  ...
  for more details. Existing state will be migrated. ([#179](https://github.com/mproffitt/terraform-provider-vsphere/issues/179))

FEATURES:

* **New Data Source:** `vsphere_tag` ([#171](https://github.com/mproffitt/terraform-provider-vsphere/issues/171))
* **New Data Source:** `vsphere_tag_category` ([#167](https://github.com/mproffitt/terraform-provider-vsphere/issues/167))
* **New Resoruce:** `vsphere_tag` ([#171](https://github.com/mproffitt/terraform-provider-vsphere/issues/171))
* **New Resoruce:** `vsphere_tag_category` ([#164](https://github.com/mproffitt/terraform-provider-vsphere/issues/164))

IMPROVEMENTS:

* resource/vsphere_folder: You can now create any kind of folder with this
  resource, not just virtual machine folders. ([#179](https://github.com/mproffitt/terraform-provider-vsphere/issues/179))
* resource/vsphere_folder: Now supports tags. ([#179](https://github.com/mproffitt/terraform-provider-vsphere/issues/179))
* resource/vsphere_folder: Now supports import. ([#179](https://github.com/mproffitt/terraform-provider-vsphere/issues/179))
* resource/vsphere_datacenter: Tags can now be applied to datacenters. ([#177](https://github.com/mproffitt/terraform-provider-vsphere/issues/177))
* resource/vsphere_nas_datastore: Tags can now be applied to NAS datastores.
  ([#176](https://github.com/mproffitt/terraform-provider-vsphere/issues/176))
...
* resource/vsphere_virtual_machine: Tags can now be applied to virtual machines.
  ([#175](https://github.com/mproffitt/terraform-provider-vsphere/issues/175))
* resource/vsphere_virtual_machine: Adjusted the customization timeout to 10
  minutes ([#168](https://github.com/mproffitt/terraform-provider-vsphere/issues/168))

BUG FIXES:

* resource/vsphere_virtual_machine: This resource can now be used with networks
  with unescaped slashes in its network name. ([#181](https://github.com/mproffitt/terraform-provider-vsphere/issues/181))
* resource/vsphere_virtual_machine: Fixed a crash where virtual NICs were
  created with networks backed by a 3rd party hardware VDS. ([#181](https://github.com/mproffitt/terraform-provider-vsphere/issues/181))
* resource/vsphere_virtual_machine: Fixed crashes and spurious diffs that were
  ...
  correct network device during refresh. ([#180](https://github.com/mproffitt/terraform-provider-vsphere/issues/180))
...
* `vsphere_virtual_machine` now waits on a _routeable_ IP address by default,
  ...
  setting `wait_for_guest_net` to `false`. ([#158](https://github.com/mproffitt/terraform-provider-vsphere/issues/158))

FEATURES:

* **New Resource:** `vsphere_virtual_machine_snapshot` ([#107](https://github.com/mproffitt/terraform-provider-vsphere/issues/107))
...
* resource/vsphere_virtual_machine: Virtual machine power state is now enforced.
  ...
  it back on during the next apply. ([#152](https://github.com/mproffitt/terraform-provider-vsphere/issues/152))
...
* resource/vsphere_virtual_machine: Fixed customization behavior to watch
  ...
  out-of-band configuration through Sysprep. ([#158](https://github.com/mproffitt/terraform-provider-vsphere/issues/158))

## 0.2.2 (September 07, 2017)

FEATURES:

* **New Resource:** `vsphere_nas_datastore` ([#149](https://github.com/mproffitt/terraform-provider-vsphere/issues/149))
* **New Resource:** `vsphere_vmfs_datastore` ([#142](https://github.com/mproffitt/terraform-provider-vsphere/issues/142))
* **New Data Source:** `vsphere_vmfs_disks` ([#141](https://github.com/mproffitt/terraform-provider-vsphere/issues/141))

## 0.2.1 (August 31, 2017)

FEATURES:

* **New Resource:** `vsphere_host_port_group` ([#139](https://github.com/mproffitt/terraform-provider-vsphere/issues/139))
* **New Resource:** `vsphere_host_virtual_switch` ([#138](https://github.com/mproffitt/terraform-provider-vsphere/issues/138))
* **New Data Source:** `vsphere_datacenter` ([#144](https://github.com/mproffitt/terraform-provider-vsphere/issues/144))
* **New Data Source:** `vsphere_host` ([#146](https://github.com/mproffitt/terraform-provider-vsphere/issues/146))

IMPROVEMENTS:

* resource/vsphere_virtual_machine: Allow customization of hostname ([#79](https://github.com/mproffitt/terraform-provider-vsphere/issues/79))
...
* resource/vsphere_virtual_machine: Fix IPv4 address mapping issues causing
  ...
  diffs as well. ([#128](https://github.com/mproffitt/terraform-provider-vsphere/issues/128))
...
* resource/vsphere_virtual_disk: Default adapter type is now `lsiLogic`,
  changed from `ide`. ([#94](https://github.com/mproffitt/terraform-provider-vsphere/issues/94))

FEATURES:

* **New Resource:** `vsphere_datacenter` ([#126](https://github.com/mproffitt/terraform-provider-vsphere/issues/126))
* **New Resource:** `vsphere_license` ([#110](https://github.com/mproffitt/terraform-provider-vsphere/issues/110))

IMPROVEMENTS:

* resource/vsphere_virtual_machine: Add annotation argument ([#111](https://github.com/mproffitt/terraform-provider-vsphere/issues/111))

BUG FIXES:

* Updated [govmomi](https://github.com/vmware/govmomi) to v0.15.0 ([#114](https://github.com/mproffitt/terraform-provider-vsphere/issues/114))
* Updated network interface discovery behaviour in refresh. [[#129](https://github.com/mproffitt/terraform-provider-vsphere/issues/129)]. This fixes
